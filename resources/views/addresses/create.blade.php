...
@section('title', 'Tambah Alamat — Revolve')
...
<div class="container-app pt-8 lg:pt-12 pb-16 max-w-3xl">
    ...
    <h1 class="text-headline-lg mb-6">Tambah Alamat Baru</h1>

    <div class="card elevation-1 bg-surface p-6 lg:p-8">
        <form method="POST" action="{{ route('addresses.store') }}" class="w-full">
            @csrf
            @include('partials.address-form', ['address' => null])
            <div class="flex flex-col sm:flex-row gap-3 mt-8">
                <button type="submit" class="btn btn-primary flex-grow sm:flex-grow-0">Simpan Alamat</button>
